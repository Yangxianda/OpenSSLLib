#
#  Be sure to run `pod spec lint OpenSSLLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Pamsun"
  # s.authors            = { "Pamsun" => "931161435@qq.com" }
  # s.social_media_url   = "http://twitter.com/Pamsun"
